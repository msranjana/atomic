...
11. **Input:** `input` — `continue` | `transform` | `handled`; sees raw text _before_ skill/template expansion.
...
**Hot reload:** Editing the _currently active_ custom theme file reloads automatically — visible feedback.
