...
import { copilotSdkLaunchOptions } from "@bastani/atomic-sdk/providers/copilot";
import { withAtomicTempEnv } from "@bastani/atomic-sdk/lib/atomic-temp";
...
async function checkClaudeAuth(): Promise<AuthCheckResult> {
  ...
  const { resolveHeadlessClaudeBin } = await import("@bastani/atomic-sdk/providers/claude");
